...
4. Results published in `docs/milestones/m35-benchmark-results.md`: machine, config, both medians, the Nx ratio, deltas vs the M30 baseline (26.187 ms/step, ~9.6x, toy config), peak memory (M32 stats), and honest caveats.
